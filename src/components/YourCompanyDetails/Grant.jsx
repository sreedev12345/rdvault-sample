...
function Grant() {
    ...
    useEffect(()=>{
        if(companyclaim.companyReducer.data === false) {
            setGrantNo(false)
            setGrantYes(false) 
            dispatch(grant(false,false))
		}
		 // eslint-disable-next-line react-hooks/exhaustive-deps
    },[companyclaim.companyReducer.data === false])

    
    useEffect(()=>{
        if(companyclaim.claimReducer.claimdata === false) {
            setGrantNo(false)
            setGrantYes(false) 
            dispatch(grant(false,false))
		}
		 // eslint-disable-next-line react-hooks/exhaustive-deps
    },[companyclaim.claimReducer.claimdata === false])
    ...
    return (
        ...
        >
                        ...
                        <div className="tell-us-about-your-company-card2">
                            <div className="tell-us-about-your-company-maincard2 column-card-1 custom-m-top-20">
                                <div className="tell-us-about-your-company-card2-width">
                                    <div className={grantno === true ||
                                      companyclaim.grantPeriod.data === true ?
                                                ...
                                                <div className="custom-checkbox">
                                                    <input name="noti_6"
                                                        ...
                                                        checked={
                                                                ...
                                                                grantno === true || companyclaim.grantPeriod.data === true ? true : false}
                                                        onChange={handleNo
                                                        }
                                                    />
                                ...
                                <div className="tell-us-about-your-company-card2-width">
                                    <div className={grantyes === true
                                        || companyclaim.grantPeriod.yes === true ?
                                        "tell-us-about-your-company-card2-label tell-us-about-your-company-card-section-label label-active" :
                                        "tell-us-about-your-company-card2-label tell-us-about-your-company-card-section-label"}>
                                        <div className="tell-us-about-your-company-card2-top">
                                            <span>Yes</span>
                                                ...
                                                <div className="custom-checkbox">
                                                    <input
                                                        ...
                                                        checked={
                                                                ...
                                                                grantyes === true || companyclaim.grantPeriod.yes === true ? true : false}
                                                        onChange={handleYes}
                                                    />
            ...
            <div className="col-md-3 col-xl-3 col-lg-3 col-sm-3 col-12">
                {
                    companyclaim.claimReducer.claimdata ===true && !companyclaim.grantPeriod.data && !companyclaim.grantPeriod.yes? 
